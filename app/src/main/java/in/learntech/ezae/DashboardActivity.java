...
import in.learntech.ezae.Chatroom.ChatRoomActivity;
import in.learntech.ezae.Events.*;
import in.learntech.ezae.Leaderboard.LeaderBoardFragment;
import in.learntech.ezae.Leaderboard.LeaderboardModel;
import in.learntech.ezae.Managers.CompanyUserManager;
import in.learntech.ezae.Managers.UserMgr;
import in.learntech.ezae.messages.MessageActivity;
...
public class DashboardActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrawerLayout drawer = (DrawerLayout) findViewById(in.learntech.ezae.R.id.drawer_layout);
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
                this, drawer, toolbar, in.learntech.ezae.R.string.navigation_drawer_open, in.learntech.ezae.R.string.navigation_drawer_close);
        ...
        NavigationView navigationView = (NavigationView) findViewById(in.learntech.ezae.R.id.nav_view);
    ...
    private void initViews(){
        mMenuHeaderLayout = (LinearLayout)getLayoutInflater().inflate(in.learntech.ezae.R.layout.nav_header_dashboard,null);
        mScores = (TextView) findViewById(in.learntech.ezae.R.id.textView_score);
        mProfileRank = (TextView) findViewById(in.learntech.ezae.R.id.textView_profile_rank);
        mPendingTrainings = (TextView) findViewById(in.learntech.ezae.R.id.textView_pending_trainings);
        ...
        learningPlanCountTextView = (TextView)findViewById(in.learntech.ezae.R.id.learningPlanCount);
        messagesCountTextView = (TextView)findViewById(in.learntech.ezae.R.id.messagesCount);
        mUserImageView = (ImageView)hView.findViewById(in.learntech.ezae.R.id.imageView_user);
        mUserName = (TextView)findViewById(in.learntech.ezae.R.id.textView_username_dash);
        mProfiles = (TextView)findViewById(in.learntech.ezae.R.id.textView_profiles_dash);
        userImageView = (ImageView)findViewById(in.learntech.ezae.R.id.imageView_userImage);
        mUserNameView = (TextView)hView.findViewById(in.learntech.ezae.R.id.textView_userName);
        mUserEmailView = (TextView)hView.findViewById(in.learntech.ezae.R.id.textView_userEmail);
        mUserProfilesView = (TextView)hView.findViewById(in.learntech.ezae.R.id.textView_profiles);
        mCompanyImage = (ImageView) findViewById(in.learntech.ezae.R.id.companyImageView);
        mVendorImage = (ImageView) findViewById(in.learntech.ezae.R.id.vendorImageView);
    ...
    private void populateUserProfile(){
        ...
        String vendorImageUrl = mUserMgr.getLoggedInUserVendorImageUrl();
        mCompanyImage.setVisibility(View.INVISIBLE);
        mVendorImage.setVisibility(View.INVISIBLE);
        ...
        if(vendorImageUrl != null) {
            mVendorImage.setVisibility(View.VISIBLE);
            mLayoutHelper.loadImageRequest(mVendorImage, vendorImageUrl, false);
        }
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == in.learntech.ezae.R.id.action_settings) {
            return true;
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == in.learntech.ezae.R.id.nav_trainings) {
            Intent intent = new Intent(this,MyTrainings.class);
            startActivity(intent);
        } else if (id == in.learntech.ezae.R.id.nav_achivements) {
            Intent intent = new Intent(this,MyAchievements.class);
            startActivity(intent);
        } else if (id == in.learntech.ezae.R.id.nav_messages) {
            Intent intent = new Intent(this,MessageActivity.class);
            startActivity(intent);
        } else if (id == in.learntech.ezae.R.id.nav_notes) {
            Intent notesIntent = new Intent(this,NotesActivity.class);
            startActivity(notesIntent);
        } else if (id == in.learntech.ezae.R.id.nav_update_profile) {
            Intent notesIntent = new Intent(this,UpdateProfileActivity.class);
            startActivity(notesIntent);
        } else if (id == in.learntech.ezae.R.id.nav_logout) {
            logoutConfirm();
        } else if(id == in.learntech.ezae.R.id.nav_change_password){
            Intent intent = new Intent(this,ChangePasswordActivity.class);
            startActivity(intent);
        }else if(id == in.learntech.ezae.R.id.nav_chatroom){
            Intent intent = new Intent(this,ChatRoomActivity.class);
            startActivity(intent);
        }
        else if(id == in.learntech.ezae.R.id.nav_Events){
            Intent intent = new Intent(this, MainActivity.class);
            startActivity(intent);
        }else if(id == in.learntech.ezae.R.id.nav_Notifications){
...
//    }
    ...
    public void onClick(View view) {
        int id = view.getId();
        if (id == in.learntech.ezae.R.id.imageView_trainings) {
            Intent intent = new Intent(this,MyTrainings.class);
            startActivity(intent);
        } else if (id == in.learntech.ezae.R.id.imageView_achievements) {
            Intent intent = new Intent(this,MyAchievements.class);
            startActivity(intent);
        } else if (id == in.learntech.ezae.R.id.imageView_messages) {
            Intent intent = new Intent(this,MessageActivity.class);
            startActivity(intent);
        } else if (id == in.learntech.ezae.R.id.imageView_notes) {
            Intent notesIntent = new Intent(this,NotesActivity.class);
            startActivity(notesIntent);
           ...
           // startActivity(notesIntent);
        //}
        else if (id == in.learntech.ezae.R.id.imageView_notifications) {
            Intent intent = new Intent(this,NotificationActivity.class);
            startActivity(intent);
        }else if (id == in.learntech.ezae.R.id.imageView_chat) {
            Intent intent = new Intent(this,ChatRoomActivity.class);
            startActivity(intent);
        }
        //else if (id == R.id.imageView_password) {
          ...
          //  startActivity(intent);
        //}
        else if (id == in.learntech.ezae.R.id.imageView_calendar) {
            Intent intent = new Intent(this, MainActivity.class);
            startActivity(intent);
        }else if (id == in.learntech.ezae.R.id.imageView_logout) {
            logout();
        }else if(id == in.learntech.ezae.R.id.imageView_userImage){
