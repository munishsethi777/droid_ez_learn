package in.learntech.ezae.utils;
...
public class StringConstants {
    ...
    public static final String GET_MODULE_DETAILS = ACTION_API_URL + "ModuleAction.php?call=getModuleDetails&userSeq={0,number,#}&moduleSeq={1,number,#}&learningPlanSeq={2,number,#}&isreattempted={3}";
