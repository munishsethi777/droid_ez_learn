...
public class NotesFragment extends Fragment implements IServiceHandler {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ConstraintLayout mFragmentLayout =  (ConstraintLayout) inflater.inflate(in.learntech.ezae.R.layout.content_notes_child, container, false);
                ...
                if (mCallName.equals(GET_ALL_NOTES)) {
                    ...
                    for (int i = 0; i < notesJsonArr.length(); i++) {
                        ...
                        SwipeHorizontalMenuLayout swipeLayout = (SwipeHorizontalMenuLayout) mInflater.inflate(
                                in.learntech.ezae.R.layout.notes_fragment, mContainer, false);
                        swipeLayout.setId(noteSeq);
                        TextView notesHeader = (TextView) swipeLayout.findViewById(in.learntech.ezae.R.id.notesHeader);
                        notesHeader.setText(noteDetails);

                        TextView notesCreatedOn = (TextView) swipeLayout.findViewById(in.learntech.ezae.R.id.notesCreatedOn);
                        notesCreatedOn.setText(noteCreatedOn);

                        RelativeLayout contentRL = (RelativeLayout) swipeLayout.findViewById(in.learntech.ezae.R.id.smContentView);
                        contentRL.setTag(in.learntech.ezae.R.string.noteSeq, noteSeq);

                        RelativeLayout deleteRL = (RelativeLayout) swipeLayout.findViewById(in.learntech.ezae.R.id.smMenuViewRight);
                        deleteRL.setTag(in.learntech.ezae.R.string.noteSeq, noteSeq);
