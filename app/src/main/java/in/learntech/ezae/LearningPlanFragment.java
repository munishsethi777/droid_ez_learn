            ...
            if(success){
                ...
                for (int i=0; i < count; i++) {
                    ...
                    LinearLayout lpFragment = (LinearLayout)
                            mInflater.inflate(in.learntech.ezae.R.layout.learning_plan_list_fragment, mContainer, false);
//                    ImageView lpImage = (ImageView)lpFragment.findViewById(R.id.imageView_lpImage);
//                    loadImageCircleRequest(lpImage,imageUrl);

                    TextView textView_title = (TextView) lpFragment.findViewById(in.learntech.ezae.R.id.textview_lpTitle);
                    textView_title.setText(title);

                    TextView textView_description = (TextView) lpFragment.findViewById(in.learntech.ezae.R.id.textView_lpDescription);
                    textView_description.setText(description);

                    TextView textView_score = (TextView) lpFragment.findViewById(in.learntech.ezae.R.id.textView_score);
                    textView_score.setText(score.toString());

                    TextView textView_points = (TextView) lpFragment.findViewById(in.learntech.ezae.R.id.textView_points);
