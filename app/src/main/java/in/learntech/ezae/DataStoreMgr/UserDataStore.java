...
public class UserDataStore{
    ...
    public static final String COLUMN_VENDOR_IMAGE = "vendorimage";
    ...
    public long save(User user){
        ...
        values.put(COLUMN_VENDOR_IMAGE,user.getVendorImage());
        int seq = user.getId();
    ...
    private User populateObject( Cursor c){
        ...
        String vendorImage = c.getString(10);
        User user = new User();
        user.setId(id);
        ...
        user.setVendorImage(vendorImage);
        return user;
    }
