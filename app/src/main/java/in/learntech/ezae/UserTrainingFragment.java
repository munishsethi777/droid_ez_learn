...
import in.learntech.ezae.Controls.SwipeDirection;
...
import in.learntech.ezae.utils.AppStatus;
import in.learntech.ezae.utils.StringConstants;
import in.learntech.ezae.utils.seekbar.CustomSeekBar;
import in.learntech.ezae.utils.sorting.ListFragment;
...
public class UserTrainingFragment extends Fragment implements IServiceHandler {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        int layout_id = in.learntech.ezae.R.layout.user_training_fragment;
        mActivity = getActivity();
        mParentLayout= (ConstraintLayout)inflater.inflate(layout_id, container, false);
        TextView textView_question = (TextView)mParentLayout.findViewById(in.learntech.ezae.R.id.textView_question);
        mOptionsLayout = (LinearLayout)mParentLayout.findViewById(in.learntech.ezae.R.id.optionsLayout);
        ...
        try{
            ...
            mModuleSeq = mModuleJson.getInt("seq");
            mLearningPlanSeq = mModuleJson.getInt("learningPlanSeq");
            if(!mModuleType.equals("elearning")) {
                ...
                submitButton = (Button) mParentLayout.findViewById(in.learntech.ezae.R.id.button_submit_progress);
                okButton = (Button) mParentLayout.findViewById(in.learntech.ezae.R.id.button_feedbackOkay);
            ...
            textVew_feedback_success = (TextView) mParentLayout.findViewById(in.learntech.ezae.R.id.textView_feedbackSuccess);
            textVew_feedback_error = (TextView) mParentLayout.findViewById(in.learntech.ezae.R.id.textView_feedbackError);
    ...
    private void addLongQuestionView()throws Exception{
        ...
        mTextView_Long_question.setId(in.learntech.ezae.R.id.textView_long_question);
    ...
    private void addSequencesViewFragment()throws Exception {
        ...
        transaction.replace(in.learntech.ezae.R.id.optionsLayout, listFragment, "fragment").commit();
    }
    ...
    private void addWebView()throws Exception{
        webView = (WebView) mParentLayout.findViewById(in.learntech.ezae.R.id.webView);
        ...
        if(mModuleType.equals("elearning")){
            ...
            mParentActivity.viewPager.setLayoutParams(layoutParams);
            webView.setWebViewClient(new WebViewClient(){
                public void onPageFinished(WebView view, String url){
                    webView.loadUrl("javascript:setUserSeq('" + mUserSeq + "')");
                    webView.loadUrl("javascript:setModuleSeq('" + mModuleSeq + "')");
                    webView.loadUrl("javascript:setlpSeq('" + mLearningPlanSeq + "')");
                }
            });
            String url = mModuleJson.getString("elearningUrl");
            webView.getSettings().setJavaScriptEnabled(true);
    ...
    private void handleSubmitButton(boolean flag){
        ...
        if(flag) {
            submitButton.setBackgroundColor(getResources().getColor(in.learntech.ezae.R.color.button_light_gray));
            ...
            submitButton.setBackgroundColor(getResources().getColor(in.learntech.ezae.R.color.button_yellow));
        }
    ...
    private void executeSaveActivityCall(){
        if(!isQuizProgressExists && !isSavedActivityData) {
            try {
                int moduleSeq = mModuleJson.getInt("seq");
                int learningPlanSeq = mModuleJson.getInt("learningPlanSeq");
