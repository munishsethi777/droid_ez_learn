...
import in.learntech.ezae.messages.MessageClickListener;
...
public class CompanyUserAdapter extends RecyclerView.Adapter<CompanyUserAdapter.ItemViewHolder> {
    ...
    public void onBindViewHolder(CompanyUserAdapter.ItemViewHolder holder, int position) {
        ...
        if(!dataList.get(position).getType().equals("user")){
            ...
            if(imageName != null && !imageName.equals("null") && !imageName.equals("")) {
                ...
                Glide.with(context)
                        .load(in.learntech.ezae.R.drawable.dummy)
                        .transform(new ImageViewCircleTransform(context))
                        .into(holder.imgProfile);
            }
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ItemViewHolder(View itemView) {
            ...
            imgProfile = (ImageView) itemView.findViewById(in.learntech.ezae.R.id.imgProfile);
            sml = (SwipeHorizontalMenuLayout) itemView.findViewById(in.learntech.ezae.R.id.sml);
           // buttonDelete = (ImageView) itemView.findViewById(R.id.buttonDelete);
            itemContainer = (LinearLayout) itemView.findViewById(in.learntech.ezae.R.id.itemContainer);
            colorMask = (LinearLayout) itemView.findViewById(in.learntech.ezae.R.id.colorMask);
            textName = (TextView) itemView.findViewById(in.learntech.ezae.R.id.textName);
        ...
        public void onClick(View v) {
            if(v.getId() == in.learntech.ezae.R.id.buttonDelete) {
                onItemDismiss(getAdapterPosition());
            }else if(v.getId() == in.learntech.ezae.R.id.check){
