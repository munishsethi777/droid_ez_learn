...
public class SendMessageActivity extends AppCompatActivity implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(in.learntech.ezae.R.layout.activity_send_message);
        Toolbar toolbar = (Toolbar) findViewById(in.learntech.ezae.R.id.toolbar);
        setSupportActionBar(toolbar);
        LinearLayoutManager layoutManager = new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false);
        rView = (SwipeMenuRecyclerView) findViewById(in.learntech.ezae.R.id.recyclerView_users);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(in.learntech.ezae.R.menu.menu_search, menu);
        final MenuItem searchItem = menu.findItem(in.learntech.ezae.R.id.action_search);
